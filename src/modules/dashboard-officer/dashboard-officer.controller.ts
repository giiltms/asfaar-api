...
@Controller('dashboard/officer')
@UseGuards(AuthGuard)
@ApiBearerAuth()
export class DashboardOfficerController {
  constructor(
    private readonly dashboardOfficerService: DashboardOfficerService,
  ) {}
  ...
  async getApplicationsForReview(
    ...
    const result = await this.dashboardOfficerService.getApplicationsForReview(
      page,
      limit,
      status,
    );
  ...
  async getApplicationForReview(
    ...
    const result = await this.dashboardOfficerService.getApplicationForReview(
      submissionId,
    );
  ...
  async reviewApplication(
    ...
    const result = await this.dashboardOfficerService.reviewApplication(
      reviewDto,
      req.user.id,
    );
  ...
  async getVerificationStats(): Promise<BaseResponseDto<VerificationStatsDto>> {
    const result = await this.dashboardOfficerService.getVerificationStats();
