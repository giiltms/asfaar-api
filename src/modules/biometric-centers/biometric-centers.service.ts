...
export class BiometricCentersService {
  ...
  async createCenter(
    ...
    try {
      ...
      // Set default values (center number will be auto-generated by middleware)
      const centerData: Prisma.BiometricCenterCreateInput = {
        ...createDto,
        centerNumber: '000', // Placeholder - will be overridden by middleware
      ...
      this.logger.log(
        `Created biometric center: ${center.name} (${center.code}) with center number: ${center.centerNumber}`,
      );
